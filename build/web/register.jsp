<%-- 
    Document   : login
    Created on : Jan 24, 2024, 12:11:20 AM
    Author     : Admin
--%>
...
<html>
    <head>
        ...
        <style>
            ...
            body {
                ...
                overflow: hidden;
                font-family: "Poppins";
                background: url(images/burger-king-mcdonalds.jpg);
    ...
    <body style="display:flex; align-items:center; justify-content:center;">
        <div class="login-page">
            <div class="form">
                <form action="checkLogin" class="register-form" method="post">
                    <h2><i class="fas fa-lock"></i> Register</h2>
                    <!--<input type="text" placeholder="Full Name *" required />-->
                    <input type="text" placeholder="Name *" name="name" value="${param.name}" required />
                    <input type="text" placeholder="Username *" name="user" value="${param.user}" required />
                    ...
                    <c:if test="${requestScope.emailFail != null}">
                        <p style="color: red;"><c:out value="${requestScope.emailFail}"/></p>
                    </c:if>    
